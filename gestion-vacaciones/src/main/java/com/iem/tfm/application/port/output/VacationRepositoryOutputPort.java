...
/**
 * Puerto de salida para operaciones de persistencia y consulta de {@link Vacation}.
 * <p>
 * Define las acciones que la capa de aplicación necesita realizar sobre el repositorio
 * de solicitudes de vacaciones. Será implementado por un adaptador en la capa de infraestructura.
 * </p>
 * 
 * @author Inigo
 * @version 1.0
...
public interface VacationRepositoryOutputPort {
	...
	/**
	 * Busca las solicitudes de vacaciones de un empleado que se solapen con un rango de fechas.
	 * 

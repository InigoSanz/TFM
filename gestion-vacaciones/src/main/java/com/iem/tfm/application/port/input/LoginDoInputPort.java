 ...
 * <p>
 * Define la operación necesaria para validar las credenciales de un usuario e
 * iniciar sesión en el sistema. Devuelve una instancia del modelo de dominio
 * {@link User} si la autenticación es exitosa.
 * </p>
 * 
 * @author Inigo
 * @version 1.0
